...
/*
See the toplevel README file to learn how to remove the GHI firmware
from the FEZ Panda board.
...
The J command returns

385941301 is not listed in the 23xx manual.

The K command returns boot code version 3.3
